                  ...
                  <div className={`border p-5 rounded-xl space-y-4 ${isDarkMode ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-zinc-200 shadow-sm'}`}>
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
                      <div>
                        ...
                        <p className="text-xs text-zinc-500">Contactos institucionales, correos electrónicos y teléfonos oficiales actualizados.</p>
                      </div>
                    </div>
                ...
                <div className="space-y-6 relative z-10">
                  <div className={`border p-5 rounded-xl space-y-4 ${isDarkMode ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-zinc-200 shadow-sm'}`}>
                    ...
                    <div className={`pt-4 border-t space-y-3 ${isDarkMode ? 'border-zinc-800' : 'border-zinc-200'}`}>
                      ...
                      <p className="text-xs text-zinc-500">Descargue un archivo de texto con todo el estado actual de su estudio jurídico para tener un respaldo seguro.</p>
                      
                      <button 
                        onClick={handleDownloadFullBackup}
                        className="bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs px-5 py-2.5 rounded shadow flex items-center gap-2"
                      >
