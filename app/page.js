              ...
              {activeTab === 'juzgados_rc' && (
                <div className="space-y-6 relative z-10">
                  <div className={`border p-6 rounded-2xl shadow-xl space-y-4 ${isDarkMode ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-zinc-200'}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
{ oficina: "Mesa de atención ciudadana - RIO CUARTO", correo: "atencionciudadana-rc@justiciacordoba.gob.ar", tel: "0358 - 4677860" },
  { oficina: "Archivo Regional - RIO CUARTO", correo: "archivoreg-rc@justiciacordoba.gob.ar", tel: "0358 - 4672142" },
  { oficina: "Asesoria de niñez, adoles., viol familiar y de genero 1 turno - rio cuarto", correo: "asevfa1-rc@justiciacordoba.gob.ar", tel: "0358 - 4677837" },
  { oficina: "Asesoria Letrada con Funciones Mult turno 1 - RIO CUARTO", correo: "asemuf1-rc@justiciacordoba.gob.ar", tel: "0358 - 4677835" },
  { oficina: "Asesoria Letrada con Funciones Mult turno 2 - RIO CUARTO", correo: "asemuf2-rc@justiciacordoba.gob.ar", tel: "0358 - 4677857" },
  { oficina: "Asesoria Letrada con Funciones Mult turno 3 - RIO CUARTO", correo: "asemuf3-rc@justiciacordoba.gob.ar", tel: "0358 - 4677836" },
  { oficina: "Camara de Apelacion Civil y cont. Administrativo 1  - RIO CUARTO", correo: "camcivmf1-rc@justiciacordoba.gob.ar", tel: "0358 - 4677821" },
  { oficina: "Camara de Apelacion Civil y cont. Administrativo 2  - RIO CUARTO", correo: "camcivmf2-rc@justiciacordoba.gob.ar", tel: "0358 - 4677822" },
  { oficina: "Camara del Crimen 2  - RIO CUARTO", correo: "campen2sec2-rc@justiciacordoba.gob.ar", tel: "0358 - 4677811" },
  { oficina: "Camara del Crimen 1 - RIO CUARTO", correo: "campen1-rc@justiciacordoba.gob.ar", tel: "0358 - 4677810" },
  { oficina: "Camara Laboral 1 secretaria 1 - RIO CUARTO", correo: "camlab1sec1-rc@justiciacordoba.gob.ar", tel: "0358 - 4677830" },
  { oficina: "Camara Laboral 1 secretaria 2 - RIO CUARTO", correo: "camlab1sec2-rc@justiciacordoba.gob.ar", tel: "0358 - 4677830" },
  { oficina: "Centro Judicial de Mediacion - RIO CUARTO", correo: "mediacion-rc@justiciacordoba.gob.ar", tel: "0358 - 4677838" },
  { oficina: "Delegacion Administracion General - RIO CUARTO", correo: "tribunales-rc@justiciacordoba.gob.ar", tel: "0358 - 4677848" },
  { oficina: "Direccion de Policia Judicial - RIO CUARTO", correo: "poljud-rc@justiciacordoba.gob.ar", tel: "Sin Teléfono" },
  { oficina: "Equipo Tecnico del Interior - RIO CUARTO", correo: "equitec-rc@justiciacordoba.gob.ar", tel: "0358 - 4677840" },
  { oficina: "Fiscalia de Camara Civil y Familia- RIO CUARTO", correo: "fiscivc-RC@justiciacordoba.gob.ar", tel: "0358 - 4677816" },
  { oficina: "Fiscalia de Camara del Crimen y Correccional - RIO CUARTO", correo: "fispenc-RC@justiciacordoba.gob.ar", tel: "0358 - 4677817" },
  { oficina: "Fiscalia de Instruccion Movil de lucha contra el narcotrafico - RIO CUARTO", correo: "fispenmvnt-RC@justiciacordoba.gob.ar", tel: "0358 - 4677858" },
  { oficina: "Fiscalia de Instruccion Multiple 3 - RIO CUARTO", correo: "fispen3-RC@justiciacordoba.gob.ar", tel: "0358 - 4677814" },
  { oficina: "Fiscalia de Instruccion Multiple 4 - RIO CUARTO", correo: "fispen4-RC@justiciacordoba.gob.ar", tel: "0358 - 4677815" },
  { oficina: "Fiscalia de Instruccion y Familia 1 - RIO CUARTO", correo: "fispen1-RC@justiciacordoba.gob.ar", tel: "0358 - 4677812" },
  { oficina: "Fiscalia de Instruccion y Familia 2 - RIO CUARTO", correo: "fispen2-RC@justiciacordoba.gob.ar", tel: "0358 - 4677813" },
  { oficina: "Intendencia - RIO CUARTO", correo: "intendencia-rc@justiciacordoba.gob.ar", tel: "0358 - 4677845" },
  { oficina: "Juzgado Civil 1 Familia 1 Secretaria 1 - RIO CUARTO", correo: "juzcivmf1sec1-rc@justiciacordoba.gob.ar", tel: "0358 - 4677823" },
  { oficina: "Juzgado Civil 1 Familia 1 Secretaria 2 - RIO CUARTO", correo: "juzciv1mfsec2-rc@justiciacordoba.gob.ar", tel: "0358 - 4677823" },
  { oficina: "Juzgado Civil 5 Familia 2 Secretaria 10 - RIO CUARTO", correo: "juzcivmf5sec10-rc@justiciacordoba.gob.ar", tel: "0358 - 4677827" },
  { oficina: "Juzgado Civil 5 Familia 2 Secretaria 9 - RIO CUARTO", correo: "juzcivmf5sec9-rc@justiciacordoba.gob.ar", tel: "0358 - 4677827" },
  { oficina: "Juzgado Civil 6 Secretaria 11 - RIO CUARTO", correo: "juzcivmf6sec11-rc@justiciacordoba.gob.ar", tel: "0358 - 4677828" },
  { oficina: "Juzgado Civil 6 Secretaria 12 - RIO CUARTO", correo: "juzcivmf6sec12-rc@justiciacordoba.gob.ar", tel: "0358 - 4677828" },
  { oficina: "Juzgado Civil 7 Secretaria 13 - RIO CUARTO", correo: "juzcivmf7sec13-rc@justiciacordoba.gob.ar", tel: "0358 - 4677852" },
  { oficina: "Juzgado Civil Multiple 2 Secretaria 3 - RIO CUARTO", correo: "juzcivmf2sec3-rc@justiciacordoba.gob.ar", tel: "0358 - 4677824" },
  { oficina: "Juzgado Civil Multiple 2 Secretaria 4 - RIO CUARTO", correo: "juzcivmf2sec4-rc@justiciacordoba.gob.ar", tel: "0358 - 4677824" },
  { oficina: "Juzgado Civil Multiple 3 Secretaria 5 - RIO CUARTO", correo: "juzcivmf3sec5-rc@justiciacordoba.gob.ar", tel: "0358 - 4677825" },
  { oficina: "Juzgado Civil Multiple 3 Secretaria 6 - RIO CUARTO", correo: "juzcivmf3sec6-rc@justiciacordoba.gob.ar", tel: "0358 - 4677825" },
  { oficina: "Juzgado Civil Multiple 4 Secretaria 7 - RIO CUARTO", correo: "juzcivmf4sec7-rc@justiciacordoba.gob.ar", tel: "0358 - 4677826" },
  { oficina: "Juzgado Civil Multiple 4 Secretaria 8 - RIO CUARTO", correo: "juzcivmf4sec8-rc@justiciacordoba.gob.ar", tel: "0358 - 4677826" },
  { oficina: "Juzgado Civil Multiple 7 Secretaria 14 - RIO CUARTO", correo: "juzcivmf7sec14-rc@justiciacordoba.gob.ar", tel: "0358 - 4677852" },
  { oficina: "Juzgado de Conciliacion 1 - RIO CUARTO", correo: "juzlab1-rc@justiciacordoba.gob.ar", tel: "0358 - 4677831" },
  { oficina: "Juzgado de Conciliacion 2 - RIO CUARTO", correo: "juzlab2-rc@justiciacordoba.gob.ar", tel: "0358 - 4677832" },
  { oficina: "Juzgado de Control Secretaria 1 - RIO CUARTO", correo: "juzpenctsec1-rc@justiciacordoba.gob.ar", tel: "0358 - 4677819" },
  { oficina: "Juzgado de Control Secretaria 2 - RIO CUARTO", correo: "juzpenctsec2-rc@justiciacordoba.gob.ar", tel: "0358 - 4677819" },
  { oficina: "Juzgado de Ejecucion Penal - RIO CUARTO", correo: "juzpenej-rc@justiciacordoba.gob.ar", tel: "0358 - 4677820" },
  { oficina: "Juzgado de Niñez, Adol., Viol. Fliar, Pen. JUv. y Genero 1 Secretaria 1 - RIO CUARTO", correo: "juzvfa1sec1-rc2@justiciacordoba.gob.ar", tel: "0358 - 4677833" },
  { oficina: "Juzgado de Niñez, Adol., Viol. Fliar, Pen. JUv. y Genero 1 Secretaria 2 - RIO CUARTO", correo: "juzvfa1sec2-rc2@justiciacordoba.gob.ar", tel: "0358 - 4677833" },
  { oficina: "Juzgado de Niñez, Adol., Viol. Fliar, Pen. JUv. y Genero 2 Secretaria 3 - RIO CUARTO", correo: "juzvfa2sec3-rc2@justiciacordoba.gob.ar", tel: "0358 - 4677834" },
  { oficina: "Juzgado de Niñez, Adol., Viol. Fliar, Pen. JUv. y Genero 2 Secretaria 4 - RIO CUARTO", correo: "juzvfa2sec4-rc2@justiciacordoba.gob.ar", tel: "0358 - 4677834" },
  { oficina: "Medicina Forense - RIO CUARTO", correo: "medforense-RC@justiciacordoba.gob.ar", tel: "0358 - 4677839" },
  { oficina: "Oficiales de Justicia, Ujieres y Notificadores - RIO CUARTO", correo: "ojun-rc@justiciacordoba.gob.ar", tel: "0358 - 4677841" },
  { oficina: "Ujieres y Notificadores - RIO CUARTO", correo: "Sin Correo", tel: "0358 - 4677842" },
  { oficina: "Oficina de Informatica", correo: "Sin Correo", tel: "0358 - 4677843" },
  { oficina: "Biblioteca", correo: "Sin Correo", tel: "0358 - 4677844" },
  { oficina: "Oficina de Ejecuciones Particulares - RIO CUARTO", correo: "oficivep-rc@justiciacordoba.gob.ar", tel: "0358 - 4677854" },
  { oficina: "Oficina Unica de Ejecucion Fiscal - RIO CUARTO", correo: "ofucivef-RC@justiciacordoba.gob.ar", tel: "0358 - 4677829" },
  { oficina: "Policia Cientifica - RIO CUARTO", correo: "polcientifica-RC@justiciacordoba.gob.ar", tel: "Sin Teléfono" },
  { oficina: "Unidad de la Defensa Publica Oficial - RIO CUARTO", correo: "udppen-rc@justiciacordoba.gob.ar", tel: "NO POSEE" },
  { oficina: "Unidad Judicial Numero Uno", correo: "Sin Correo", tel: "0358 - 4677846" },
  { oficina: "Unidad Judicial Numero Dos", correo: "Sin Correo", tel: "0358 - 4677847" },
  { oficina: "Unidad Judicial Numero Tres", correo: "Sin Correo", tel: "0358 - 4750061" }  { oficina: "Asesoria Letrada con Funciones Mult turno 3 - RIO CUARTO", correo: "asemuf3-rc@justiciacordoba.gob.ar", tel: "0358 - 4677836" },
  { oficina: "Camara de Apelacion Civil y cont. Administrativo 1  - RIO CUARTO", correo: "camcivmf1-rc@justiciacordoba.gob.ar", tel: "0358 - 4677821" },
  { oficina: "Camara de Apelacion Civil y cont. Administrativo 2  - RIO CUARTO", correo: "camcivmf2-rc@justiciacordoba.gob.ar", tel: "0358 - 4677822" },
  { oficina: "Camara del Crimen 2  - RIO CUARTO", correo: "campen2sec2-rc@justiciacordoba.gob.ar", tel: "0358 - 4677811" },
  { oficina: "Camara del Crimen 1 - RIO CUARTO", correo: "campen1-rc@justiciacordoba.gob.ar", tel: "0358 - 4677810" },
  ...
  { oficina: "Unidad Judicial Numero Uno", correo: "Sin Correo", tel: "0358 - 4677846" },
  { oficina: "Unidad Judicial Numero Dos", correo: "Sin Correo", tel: "0358 - 4677847" },
  { oficina: "Unidad Judicial Numero Tres", correo: "Sin Correo", tel: "0358 - 4750061" }
];                      ].map((j, i) => (
